        ...
        while (run) {
            ...
            switch (choise) {
                ...
                case 9:
                    ...
                    FileWriter fw = null;
                    Set<Integer> ID = databaze.keySet();
                    try {
                        fw = new FileWriter(zapis);
                        for (Integer i : ID){
                            if (databaze.get(i) instanceof technicanStudent) {
                                fw.write(i + " " + databaze.get(i).getName() + " " + databaze.get(i).getSurname() + " " + databaze.get(i).getDay() + " " + databaze.get(i).getMonth() + " " +
                                        databaze.get(i).getYear() + " " + databaze.get(i).getMean() + " technology");
                                for (int j = 0; j<databaze.get(i).getMarks().size();j++){
                                    fw.write(" " + databaze.get(i).getMarks().get(j));
                                }
                                fw.write("\n");
                            }
                            else if (databaze.get(i) instanceof combinadStudent) {
                                fw.write(i + " " + databaze.get(i).getName() + " " + databaze.get(i).getSurname() + " " + databaze.get(i).getDay() + " " + databaze.get(i).getMonth() + " " +
                                        databaze.get(i).getYear() + " " + databaze.get(i).getMean() + " kombination");
                                for (int j = 0; j<databaze.get(i).getMarks().size();j++){
                                    fw.write(" " + databaze.get(i).getMarks().get(j));
                                }
                                fw.write("\n");
                            ...
                            else if (databaze.get(i) instanceof humanitaryStudent){
                                fw.write(i + " " + databaze.get(i).getName() + " " + databaze.get(i).getSurname() + " " + databaze.get(i).getDay() + " " + databaze.get(i).getMonth() + " " +
                                        databaze.get(i).getYear() + " " + databaze.get(i).getMean() + " humanity");
                                for (int j = 0; j<databaze.get(i).getMarks().size();j++){
                                    fw.write(" " + databaze.get(i).getMarks().get(j));
                                }
                                fw.write("\n");
                ...
                case 10:
                    ...
                    while (line != null){
                        ...
                        float study_average = Float.parseFloat(parts[6]);
                        ...
                        if (group.equals("technology")) {
                            databaze.put(id, new technicanStudent(id, name, surname, day, month, year));
                            databaze.get(id).setMean(study_average);
                            for (int i = 0; i < grades.size(); i++) {
                                databaze.get(id).mark(grades.get(i));
                            }
                        }
                        else if(group.equals("kombination")){
                            databaze.put(id, new combinadStudent(id, name, surname, day, month, year));
                            databaze.get(id).setMean(study_average);
                            for (int i = 0; i < grades.size(); i++) {
                                databaze.get(id).mark(grades.get(i));
                            }
                        }
                        else if (group.equals("humanity")){
                            databaze.put(id, new humanitaryStudent(id, name, surname, day, month, year));
                            databaze.get(id).setMean(study_average);
                            for (int i = 0; i < grades.size(); i++){
                                databaze.get(id).mark(grades.get(i));
                            }
